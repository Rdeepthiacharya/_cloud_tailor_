					...
					<div align="center">
						<%
								try {
									...
									String s1 = "select pic as Picture,rate as Rate,pdesc as ProductDescription, size as Size, stock as Stock,pid as ProductId from product";
									...
									while (rs.next()) {
										...
										for (int x = 1; x <= n; x++) {
											s = rs.getString(x);
											if (x == 1) {
												out.println("<td><img src='images/" + s + "'width=240 ></img></td>");
											} else {
										...
										out.println("<td><b><a href=eproduct1.jsp?d=" + s5 + ">EDIT</b><a/><br><br>");
										out.println("<b><a href=deleteproduct.jsp?d=" + s5 + ">Delete</b><a/></td>");
										out.println("</tr>");
									}
